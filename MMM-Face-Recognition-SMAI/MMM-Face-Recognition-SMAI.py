...
Tony_image = face_recognition.load_image_file("/home/pi/Desktop/MagicMirror/modules/MMM-Face-Recognition-SMAI/public/Tony.jpeg")
Tony_face_encoding = face_recognition.face_encodings(Tony_image)[0]

Obama_image = face_recognition.load_image_file("/home/pi/Desktop/MagicMirror/modules/MMM-Face-Recognition-SMAI/public/Obama.jpeg")
Obama_face_encoding = face_recognition.face_encodings(Obama_image)[0]

Jordan_image = face_recognition.load_image_file("/home/pi/Desktop/MagicMirror/modules/MMM-Face-Recognition-SMAI/public/Jordan.jpeg")
Jordan_face_encoding = face_recognition.face_encodings(Jordan_image)[0]

GuoYuan_image = face_recognition.load_image_file("/home/pi/Desktop/MagicMirror/modules/MMM-Face-Recognition-SMAI/public/GuoYuan.jpeg")
GuoYuan_face_encoding = face_recognition.face_encodings(GuoYuan_image)[0]

ShenLu_image = face_recognition.load_image_file("/home/pi/Desktop/MagicMirror/modules/MMM-Face-Recognition-SMAI/public/ShenLu.jpeg")
...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        f = open("/home/pi/Desktop/MagicMirror/modules/MMM-Face-Recognition-SMAI/sample.txt", "w")
        f.write(name)
        f.close()
