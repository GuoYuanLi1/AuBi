...
module.exports = NodeHelper.create({
  ...
  socketNotificationReceived: function(notification, payload) {
    switch(notification) {
      ...
      var fs = require('fs');
      fs.readFile("/home/pi/Desktop/MagicMirror/modules/MMM-Face-Recognition-SMAI/sample.txt", function(err,data)
            {
                if(err)
                    console.log(err)
                else{
  ...
  /*
      fs.readdir('/home/pi/Desktop/MagicMirror/modules/MMM-Face-Recognition-SMAI/public/', (err, datadir) => {
        if (err) throw err;
