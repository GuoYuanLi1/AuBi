...
Module.register("Battery",{
	...
	getDom: function() {
		...
		if(this.config.battery_level > 20) timeago.innerText = "Idle Battery Level";
		else timeago.innerText = "Low Battery Alert";
		timeago.style.fontSize = "30pt";
		timeago.style.lineHeight = "30pt"
