     ...
     if (notification === 'CARGO_START') {
      ...
      // var return_home = '';
        ...
        if(payload === 0) {
            ...
            fs.writeFile("/home/pi/Desktop/MagicMirror/modules/Cargo/name.txt", "111", function (err) {
              if(err) {
                console.log("Error occured: write file failed")
              }else{
                name_web = "222";
            ...
            // Close Lock
            fs.writeFile("/home/pi/Desktop/MagicMirror/modules/Cargo/fingerprint.txt", "222", function (err) {
              if(err) {
                console.log("Error occured: write file failed")
              }else{
                name_finger = '111';
